...
export class UsersController {
  ...
  list = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const data = await this.service.listUsers(req.instituteId!, {
        role: role as string,
  ...
  updateStatus = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const data = await this.service.updateStatus(req.params.id, req.instituteId!, status);
  ...
  changeRole = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const data = await this.service.changeRole(req.params.id, req.instituteId!, role);
  ...
  getUser = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const data = await this.service.getUserById(req.params.id, req.instituteId!);
