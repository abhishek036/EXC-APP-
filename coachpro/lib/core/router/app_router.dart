  ...
  static GoRouter router(AuthBloc authBloc) => GoRouter(
        ...
        routes: [
          ...
          StatefulShellRoute.indexedStack(
            ...
            branches: [
              // Branch 0 — Home
              StatefulShellBranch(navigatorKey: _adm0, routes: [
                GoRoute(
                  path: '/admin',
                  ...
                  routes: [
                    ...
                    GoRoute(path: 'announcements', name: 'admin-announcements', pageBuilder: (c, s) => _page(s, const AnnouncementsPage())),
                    GoRoute(path: 'notifications', name: 'admin-notifications', pageBuilder: (c, s) => _page(s, const NotificationsPage())),
                    GoRoute(path: 'profile', name: 'admin-profile', pageBuilder: (c, s) => _page(s, const ProfilePage())),
                    GoRoute(path: 'chat-list', name: 'admin-chat-list', pageBuilder: (c, s) => _page(s, const ChatListPage()), routes: [
                      GoRoute(path: 'chat/:id', name: 'admin-chat', pageBuilder: (c, s) => _page(s, ChatPage(batchId: s.pathParameters['id'] ?? ''))),
                    ]),
                    GoRoute(path: 'live-session', name: 'admin-live-session', pageBuilder: (c, s) => _page(s, const LiveSessionPage())),
                    GoRoute(path: 'video-player', name: 'admin-video-player', pageBuilder: (c, s) => _page(s, const VideoPlayerPage())),
                    GoRoute(path: 'fee-payment', name: 'admin-fee-payment', pageBuilder: (c, s) => _page(s, const FeePaymentPage())),
                    GoRoute(path: 'whatsapp-broadcast', name: 'admin-whatsapp', pageBuilder: (c, s) => _page(s, const WhatsAppBroadcastPage())),
                    GoRoute(path: 'data-export', name: 'admin-data-export', pageBuilder: (c, s) => _page(s, const DataExportPage())),
                    GoRoute(path: 'auto-notifications', name: 'admin-auto-notifications', pageBuilder: (c, s) => _page(s, const AutomatedNotificationsPage())),
                    GoRoute(path: 'notification-settings', name: 'admin-notification-settings', pageBuilder: (c, s) => _page(s, const NotificationSettingsPage())),
                    ...
                    GoRoute(path: 'academics', name: 'admin-academics', pageBuilder: (c, s) => _page(s, const AcademicOversightPage())),
              ...
              StatefulShellBranch(navigatorKey: _adm4, routes: [
                GoRoute(
                  ...
                  routes: [
                    GoRoute(path: 'institute', name: 'admin-institute-settings', pageBuilder: (c, s) => _page(s, const InstituteSettingsPage())),
                  ],
                ),
              ]),
            ],
          ...
          StatefulShellRoute.indexedStack(
            ...
            branches: [
              // Branch 0 — Home
              StatefulShellBranch(navigatorKey: _tch0, routes: [
                GoRoute(
                  path: '/teacher',
                  ...
                  routes: [
                    ...
                    GoRoute(path: 'live-session', name: 'teacher-live-session', pageBuilder: (c, s) => _page(s, const LiveSessionPage())),
                    GoRoute(path: 'video-player', name: 'teacher-video-player', pageBuilder: (c, s) => _page(s, const VideoPlayerPage())),
          ...
          StatefulShellRoute.indexedStack(
            ...
            builder: (context, state, shell) => CPRoleShell(
              navigationShell: shell,
              items: const [
                CPBottomNavItem(icon: Icons.dashboard_outlined, activeIcon: Icons.dashboard_rounded, label: 'Home'),
                CPBottomNavItem(icon: Icons.class_outlined, activeIcon: Icons.class_rounded, label: 'Batches'),
                CPBottomNavItem(icon: Icons.menu_book_outlined, activeIcon: Icons.menu_book_rounded, label: 'Materials'),
                CPBottomNavItem(icon: Icons.chat_bubble_outline_rounded, activeIcon: Icons.chat_bubble_rounded, label: 'Chats'),
                CPBottomNavItem(icon: Icons.person_outline_rounded, activeIcon: Icons.person_rounded, label: 'Profile'),
              ],
            ),
            branches: [
              // Branch 0 — Home
              StatefulShellBranch(navigatorKey: _stu0, routes: [
                GoRoute(
                  path: '/student',
                  name: 'student-dashboard',
                  pageBuilder: (c, s) => _page(s, const StudentDashboardPage()),
                  routes: [
                    GoRoute(path: 'quiz', name: 'quizzes-list', pageBuilder: (c, s) => _page(s, const QuizzesListPage()), routes: [
                      GoRoute(path: ':id', name: 'quiz-taking', pageBuilder: (c, s) => _page(s, QuizTakingPage(quizId: s.pathParameters['id'] ?? ''))),
                    ]),
                    GoRoute(path: 'syllabus', name: 'syllabus-tracker', pageBuilder: (c, s) => _page(s, const SyllabusTrackerPage())),
                    GoRoute(path: 'results', name: 'exam-results', pageBuilder: (c, s) => _page(s, const ExamResultsPage())),
                    GoRoute(path: 'performance', name: 'student-performance', pageBuilder: (c, s) => _page(s, const PerformanceDashboardPage())),
                    ...
                    GoRoute(path: 'announcements', name: 'student-announcements', pageBuilder: (c, s) => _page(s, const AnnouncementsPage())),
                    GoRoute(path: 'live-session', name: 'student-live-session', pageBuilder: (c, s) => _page(s, const LiveSessionPage())),
                    GoRoute(path: 'video-player', name: 'student-video-player', pageBuilder: (c, s) => _page(s, const VideoPlayerPage())),
                    GoRoute(path: 'fee-payment', name: 'student-fee-payment', pageBuilder: (c, s) => _page(s, const FeePaymentPage())),
                    GoRoute(path: 'settings', name: 'student-settings', pageBuilder: (c, s) => _page(s, const SettingsPage())),
                    GoRoute(path: 'leaderboard', name: 'student-leaderboard', pageBuilder: (c, s) => _page(s, const LeaderboardPage())),
                    GoRoute(path: 'video-lectures', name: 'student-video-lectures', pageBuilder: (c, s) => _page(s, const VideoLecturesPage())),
                    GoRoute(path: 'notification-settings', name: 'student-notification-settings', pageBuilder: (c, s) => _page(s, const NotificationSettingsPage())),
                    GoRoute(path: 'language', name: 'student-language', pageBuilder: (c, s) => _page(s, const LanguageSelectionPage())),
                  ],
                ),
              ]),
              // Branch 1 — Batches
              ...
              StatefulShellBranch(navigatorKey: _stu2, routes: [
                GoRoute(path: '/student/materials', name: 'study-materials', pageBuilder: (c, s) => _page(s, const StudyMaterialsPage())),
              ]),
              // Branch 3 — Chats
              StatefulShellBranch(navigatorKey: _stu3, routes: [
                GoRoute(
                  path: '/student/chat-list',
                  name: 'student-chat-list',
                  pageBuilder: (c, s) => _page(s, const ChatListPage()),
                  routes: [
                    GoRoute(path: 'chat/:id', name: 'student-chat', pageBuilder: (c, s) => _page(s, ChatPage(batchId: s.pathParameters['id'] ?? ''))),
                  ],
                ),
              ]),
              // Branch 4 — Profile
              StatefulShellBranch(navigatorKey: _stu4, routes: [
                GoRoute(path: '/student/profile', name: 'student-self-profile', pageBuilder: (c, s) => _page(s, const ProfilePage())),
              ]),
            ],
          ),
          ...
          StatefulShellRoute.indexedStack(
            ...
            builder: (context, state, shell) => CPRoleShell(
              ...
              items: const [
                CPBottomNavItem(icon: Icons.dashboard_outlined, activeIcon: Icons.dashboard, label: 'Home'),
                CPBottomNavItem(icon: Icons.chat_bubble_outline, activeIcon: Icons.chat_bubble, label: 'Chat'),
                CPBottomNavItem(icon: Icons.receipt_long_outlined, activeIcon: Icons.receipt_long, label: 'Fees'),
                CPBottomNavItem(icon: Icons.person_outline, activeIcon: Icons.person, label: 'Profile'),
              ],
            ),
            branches: [
              // Branch 0 — Home
              StatefulShellBranch(navigatorKey: _par0, routes: [
                GoRoute(
                  path: '/parent',
                  name: 'parent-dashboard',
                  pageBuilder: (c, s) => _page(s, const ParentDashboardPage()),
                  routes: [
                    GoRoute(path: 'notifications', name: 'parent-notifications', pageBuilder: (c, s) => _page(s, const NotificationsPage())),
                    GoRoute(path: 'settings', name: 'parent-settings', pageBuilder: (c, s) => _page(s, const SettingsPage())),
                    GoRoute(path: 'announcements', name: 'parent-announcements', pageBuilder: (c, s) => _page(s, const AnnouncementsPage())),
                    GoRoute(path: 'live-session', name: 'parent-live-session', pageBuilder: (c, s) => _page(s, const LiveSessionPage())),
                    GoRoute(path: 'video-player', name: 'parent-video-player', pageBuilder: (c, s) => _page(s, const VideoPlayerPage())),
                    GoRoute(path: 'results', name: 'parent-results', pageBuilder: (c, s) => _page(s, const ExamResultsPage())),
                    GoRoute(path: 'weekly-report/:id', name: 'parent-weekly-report', pageBuilder: (c, s) => _page(s, WeeklyReportPage(studentId: s.pathParameters['id'] ?? ''))),
                    GoRoute(path: 'payment-history', name: 'parent-payment-history', pageBuilder: (c, s) => _page(s, const PaymentHistoryPage())),
                    GoRoute(path: 'leaderboard', name: 'parent-leaderboard', pageBuilder: (c, s) => _page(s, const LeaderboardPage())),
                    GoRoute(path: 'video-lectures', name: 'parent-video-lectures', pageBuilder: (c, s) => _page(s, const VideoLecturesPage())),
                    GoRoute(path: 'notification-settings', name: 'parent-notification-settings', pageBuilder: (c, s) => _page(s, const NotificationSettingsPage())),
                    GoRoute(path: 'language', name: 'parent-language', pageBuilder: (c, s) => _page(s, const LanguageSelectionPage())),
                  ],
                ),
              ]),
              // Branch 1 — Chat
              StatefulShellBranch(navigatorKey: _par1, routes: [
                GoRoute(
                  path: '/parent/chat-list',
                  name: 'parent-chat-list',
                  pageBuilder: (c, s) => _page(s, const ChatListPage()),
                  routes: [
                    GoRoute(path: 'chat', name: 'parent-chat', pageBuilder: (c, s) => _page(s, ChatPage(batchId: (s.extra as Map<String, dynamic>?)?['batchId'] ?? ''))),
                  ],
                ),
              ]),
              // Branch 2 — Fees
              StatefulShellBranch(navigatorKey: _par2, routes: [
                GoRoute(path: '/parent/fee-payment', name: 'parent-fee-payment', pageBuilder: (c, s) => _page(s, const FeePaymentPage())),
              ]),
              // Branch 3 — Profile
              StatefulShellBranch(navigatorKey: _par3, routes: [
                GoRoute(path: '/parent/profile', name: 'parent-self-profile', pageBuilder: (c, s) => _page(s, const ProfilePage())),
              ]),
            ],
          ),
        ],
