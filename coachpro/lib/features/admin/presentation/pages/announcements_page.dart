...
class _AnnouncementsPageState extends State<AnnouncementsPage> {
  ...
  Future<void> _loadAnnouncements() async {
    ...
    try {
      ...
      final data = await _adminRepo.getAnnouncements(
        category: filterValue == 'All' ? null : filterValue,
      );
      if (!mounted) return;
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final isAdmin =
        authState is AuthAuthenticated && authState.user.role.name == 'admin';
  ...
  Future<void> _showEditAnnouncementSheet(
  ...
  Future<void> _deleteAnnouncement(String id) async {
    ...
    final conf = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'This action will permanently remove this broadcast from all feeds. Proceed?',
          style: GoogleFonts.plusJakartaSans(
            fontSize: 14,
