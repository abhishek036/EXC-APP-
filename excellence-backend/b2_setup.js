...
const BUCKET_NAME = 'excellence-' + Math.floor(Math.random() * 1000000) + '-storage';
...
async function setup() {
  try {
    ...
    let bucket = listRes.data.buckets.find(b => b.bucketType === 'allPrivate' && b.bucketName.startsWith('excellence'));
