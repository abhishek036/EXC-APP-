...
class AppColors {
  ...
  static const Color saharaYellow = Color(0xFFFFC800);
  ...
  static const Color shadowGrey = Color(
    0xFF0A0A0A,
  ...
  static const Color frostBlue = Color(
    0xFFF0F3FF,
  ); // subtle cool-blue surface tint
  static const Color steelBlue =
      chambrayBlue; // primary blue — CTAs, active states
