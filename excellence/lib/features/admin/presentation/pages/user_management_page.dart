...
class _UserManagementPageState extends State<UserManagementPage> {
  ...
  Future<void> _updateClearanceLevel(
    Map<String, dynamic> user,
    String newRole,
  ) async {
    try {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'CURRENT CLEARANCE: ${role.toUpperCase()}',
                        style: GoogleFonts.plusJakartaSans(
                          fontSize: 9,
                          fontWeight: FontWeight.w900,
                ...
                children: [
                  if (status != 'ACTIVE')
                    _actionButton(
                      ...
                      () {
                        Navigator.pop(ctx);
                        _updateSecurityState(user, 'ACTIVE');
                      },
                      isDark,
                    ),
                  if (status != 'BLOCKED') ...[
                    ...
                    _actionButton(
                      ...
                      () {
                        Navigator.pop(ctx);
                        _updateSecurityState(user, 'BLOCKED');
                      },
                      isDark,
                    ),
                  ],
                  if (status != 'INACTIVE') ...[
                    ...
                    _actionButton(
                      ...
                      () {
                        Navigator.pop(ctx);
                        _updateSecurityState(user, 'INACTIVE');
                      },
                      isDark,
                    ),
                  ],
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Background Glows
          if (isDark) ...[
            Positioned(top: -150, right: -50, child: const SizedBox.shrink()),
            Positioned(bottom: 100, left: -100, child: const SizedBox.shrink()),
            Positioned(top: 400, left: 200, child: const SizedBox.shrink()),
          ],
                  ...
                  child: _isLoading
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (_, i) =>
                                _buildEliteUserCard(_users[i], isDark)
          ...
          items: items
              .map(
                (item) => DropdownMenuItem(
                  value: item,
                  child: Text(
                    item.isEmpty ? hint : item.toUpperCase(),
                    style: GoogleFonts.plusJakartaSans(
                      fontSize: 11,
                      fontWeight: FontWeight.w800,
                    ),
