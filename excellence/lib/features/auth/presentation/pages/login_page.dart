...
class _LoginPageState extends State<LoginPage> with ThemeAware<LoginPage> {
  ...
  void _handleSendOtp() {
    ...
    context.read<AuthBloc>().add(
      AuthSendOtpRequested(
        ...
        joinCode: _joinCodeController.text.trim().isEmpty
            ? null
  ...
  void _handlePasswordLogin() {
    ...
    setState(() {
      _identifierError = identifier.length < 3
          ? 'Enter phone number or username'
          : null;
      _passwordError = password.length < 4
                  ...
                  child: Column(
                    children: [
                      ...
                      CPPressable(
                        onTap: () => CPToast.info(
                          context,
                          'Biometric login will be enabled soon.',
                        ),
                        child: Container(
