                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('|| JAI MATA DI ||',
                        style: GoogleFonts.plusJakartaSans(fontSize: 13, fontWeight: FontWeight.w800, color: const Color(0xFFD84315), letterSpacing: 1.5),
                      ).animate(delay: 100.ms).fadeIn(),
                      const SizedBox(height: 2),
                      Text('Excellence Academy',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.playfairDisplay(fontSize: 34, fontWeight: FontWeight.w800, fontStyle: FontStyle.italic, color: AppColors.elitePrimary, letterSpacing: -0.5),
                      ).animate(delay: 150.ms).fadeIn(),
                      const SizedBox(height: 6),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Icon(Icons.menu, color: Colors.green, size: 14),
                          const SizedBox(width: 6),
                          Text('The Best Mentor & Motivator of Students',
                            style: GoogleFonts.plusJakartaSans(fontSize: 12, color: const Color(0xFFD84315), fontWeight: FontWeight.w700),
                          ),
                          const SizedBox(width: 6),
                          const Icon(Icons.menu, color: Colors.green, size: 14),
                        ],
