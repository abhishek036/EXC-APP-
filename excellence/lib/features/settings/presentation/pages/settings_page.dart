...
class _SettingsPageState extends State<SettingsPage> {
            ...
            return Column(
              ...
              children: [
                ...
                _settingsTile(
                  ...
                  onTap: () => context.go('${context.rolePrefix}/profile'),
                  isDark: isDark,
                ),
                _settingsTile(
                  Icons.lock_outline,
                ...
                _settingsTile(
                  ...
                  subtitle: 'System permission and delivery preferences',
                  onTap: () => context.push(
                    '${context.rolePrefix}/notification-settings',
                  ),
                  isDark: isDark,
                ),
                _settingsToggle(
                ...
                _settingsTile(
                  ...
                  onTap: () => showLicensePage(
                    context: context,
                    applicationName: 'Excellence Academy',
            ...
            ...['Auto', '1080p', '720p', '480p', '360p'].map(
              (q) => CPPressable(
                onTap: () {
                  ...
                  _saveString('videoQuality', q);
                  Navigator.pop(ctx);
                },
                child: Padding(
                  padding: const EdgeInsets.symmetric(
                    vertical: AppDimensions.step,
                  ),
                  child: Row(
                    children: [
                      Icon(
  ...
  void _showDataExportDialog() {
    showDialog(
      context: context,
      builder: (ctx) => _DataExportDialog(
        accent: CT.accent(context),
        card: CT.card(context),
        textH: CT.textH(context),
        textS: CT.textS(context),
      ),
    );
  }
    ...
    final faqs = [
      {
        ...
        'a':
            'Go to Settings → Change Password. Enter your current password and set a new one.',
      },
      {
        'q': 'How do I change my profile picture?',
        'a':
            'Navigate to your Profile page and tap on the avatar to upload a new photo.',
      },
      {
        'q': 'Can I access content offline?',
        'a':
            'Yes! Enable Offline Mode in Settings → Content & Downloads to save materials for offline use.',
      },
      {
        'q': 'How do I contact my teacher?',
        'a':
            'Use the Chat feature from your dashboard to send direct messages to your assigned teachers.',
      },
      {
        'q': 'How do I view my test results?',
        'a':
            'Go to your Performance Dashboard from the home screen to see all test scores and analytics.',
      },
      {
        'q': 'How do I pay fees?',
        'a':
            'Navigate to the Fees section and select the pending fee to make payment through multiple payment options.',
      },
      {
        'q': 'Is my data secure?',
        'a':
            'Yes, all data is encrypted and stored securely. We follow industry-standard security practices.',
      },
    ];
    showModalBottomSheet(
      context: context,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) => Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: CT.border(context).withValues(alpha: 0.5),
                    ),
                  ),
                  child: ExpansionTile(
                    ...
                    iconColor: CT.accent(context),
                    collapsedIconColor: CT.textM(context),
                    children: [
                      Text(
                        faqs[i]['a']!,
                        style: GoogleFonts.plusJakartaSans(
                    ...
                    .map(
                      (t) => CPPressable(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: selectedTopic == t
                                ? CT.accent(context).withValues(alpha: 0.1)
                                : CT.card(context),
              ...
              Row(
                children: ['Low', 'Medium', 'High', 'Critical'].map((s) {
                  final colors = {
                    ...
                    'Medium': AppColors.moltenAmber,
                    'High': AppColors.coralRed,
                      ...
                      child: CPPressable(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: severity == s ? c : CT.border(context),
                            ),
                          ),
                          ...
                          child: Text(
                            ...
                            style: GoogleFonts.plusJakartaSans(
                              fontSize: 11,
                              fontWeight: FontWeight.w600,
                              color: severity == s ? c : CT.textS(context),
                            ),
                          ),
                        ),
                      ),
    ...
    child: Container(
      ...
      child: Row(
        children: [
          ...
          trailing ??
              Icon(Icons.chevron_right, color: CT.textM(context), size: 20),
        ],
      ),
    ),
  );
    ...
    child: Row(
      children: [
        ...
        Switch.adaptive(
          value: value,
          onChanged: onChanged,
          activeTrackColor: CT.accent(context),
        ),
      ],
    ),
  );
    ...
    content: Column(
      ...
      children: [
        if (!_exporting && !_done) ...[
          ...
          const SizedBox(height: 8),
          Text(
            'This will prepare a download of your profile, attendance, scores, and activity data.',
            style: GoogleFonts.plusJakartaSans(
              fontSize: 13,
              color: widget.textS,
              height: 1.5,
          ...
          TextButton(
            ...
            child: Text(
              'Cancel',
              style: GoogleFonts.plusJakartaSans(color: widget.textS),
            ),
          ),
        ],
        if (_exporting) ...[
